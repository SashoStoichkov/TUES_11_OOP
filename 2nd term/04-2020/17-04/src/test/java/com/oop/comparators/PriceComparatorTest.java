...
import main.java.com.oop.comparators.PriceComparator;
...
class PriceComparatorTest {
    ...
    @Test
    void compareEquals() {
        int result = priceComparator.compare(car1, car1);
        assertEquals(0, result);
        assertFalse(result > 0);
        assertFalse(result < 0);

        result = priceComparator.compare(car2, car2);
        assertEquals(0, result);
        assertFalse(result > 0);
        assertFalse(result < 0);

        result = priceComparator.compare(car3, car3);
        assertEquals(0, result);
        assertFalse(result > 0);
        assertFalse(result < 0);
    }
    ...
    void compareGreaterThan() {
        int result = priceComparator.compare(car2, car1);
        assertTrue(result > 0);
        assertNotEquals(0, result);
        assertFalse(result < 0);

        result = priceComparator.compare(car2, car3);
        assertTrue(result > 0);
        assertNotEquals(0, result);
        assertFalse(result < 0);

        result = priceComparator.compare(car1, car3);
        assertTrue(result > 0);
        assertNotEquals(0, result);
        assertFalse(result < 0);
    }
    ...
    void compareSmallerThan() {
        ...
        result = priceComparator.compare(car3, car2);
        assertTrue(result < 0);
        assertNotEquals(0, result);
        assertFalse(result > 0);

        result = priceComparator.compare(car3, car1);
        assertTrue(result < 0);
        assertNotEquals(0, result);
        assertFalse(result > 0);
    }
