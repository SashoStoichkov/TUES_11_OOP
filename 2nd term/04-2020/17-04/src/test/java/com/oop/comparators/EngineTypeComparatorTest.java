...
class EngineTypeComparatorTest {
    private EngineTypeComparator engineTypeComparator;
    private Car car1;
    private Car car2;
    private Car car3;
    ...
    @BeforeEach
    void setUp() {
        engineTypeComparator = new EngineTypeComparator();
    ...
    @Test
    void compareEquals() {
        int result = engineTypeComparator.compare(car1, car1);
        assertEquals(0, result);
        assertFalse(result > 0);
        assertFalse(result < 0);

        result = engineTypeComparator.compare(car2, car2);
        assertEquals(0, result);
        assertFalse(result > 0);
        assertFalse(result < 0);

        result = engineTypeComparator.compare(car3, car3);
        assertEquals(0, result);
        assertFalse(result > 0);
        assertFalse(result < 0);
    }
    ...
    void compareGreaterThan() {
        int result = engineTypeComparator.compare(car1, car2);
        assertTrue(result > 0);
        assertNotEquals(0, result);
        assertFalse(result < 0);

        result = engineTypeComparator.compare(car3, car2);
        assertTrue(result > 0);
        assertNotEquals(0, result);
        assertFalse(result < 0);

        result = engineTypeComparator.compare(car1, car3);
        assertTrue(result > 0);
        assertNotEquals(0, result);
        assertFalse(result < 0);
    }
    ...
    void compareSmallerThan() {
        int result = engineTypeComparator.compare(car2, car1);
        assertTrue(result < 0);
        assertNotEquals(0, result);
        assertFalse(result > 0);

        result = engineTypeComparator.compare(car2, car3);
        assertTrue(result < 0);
        assertNotEquals(0, result);
        assertFalse(result > 0);

        result = engineTypeComparator.compare(car3, car1);
        assertTrue(result < 0);
        assertNotEquals(0, result);
        assertFalse(result > 0);
    }
