...
import main.java.com.oop.comparators.ModelComparator;
...
class ModelComparatorTest {
    ...
    @Test
    void compareEquals() {
        int result = modelComparator.compare(car1, car1);
        assertEquals(0, result);
        assertFalse(result > 0);
        assertFalse(result < 0);

        result = modelComparator.compare(car2, car2);
        assertEquals(0, result);
        assertFalse(result > 0);
        assertFalse(result < 0);

        result = modelComparator.compare(car3, car3);
        assertEquals(0, result);
        assertFalse(result > 0);
        assertFalse(result < 0);

        result = modelComparator.compare(car1, car2);
        assertEquals(0, result);
        assertFalse(result > 0);
        assertFalse(result < 0);
    }
    ...
    void compareGreaterThan() {
        int result = modelComparator.compare(car1, car3);
        assertTrue(result > 0);
        assertNotEquals(0, result);
        assertFalse(result < 0);

        result = modelComparator.compare(car2, car3);
        assertTrue(result > 0);
        assertNotEquals(0, result);
        assertFalse(result < 0);
    }
    ...
    void compareSmallerThan() {
        int result = modelComparator.compare(car3, car1);
        assertTrue(result < 0);
        assertNotEquals(0, result);
        assertFalse(result > 0);

        result = modelComparator.compare(car3, car2);
        assertTrue(result < 0);
        assertNotEquals(0, result);
        assertFalse(result > 0);
    }
