...
class RegionComparatorTest {
    private RegionComparator regionComparator;
    private Car car1;
    private Car car2;
    private Car car3;
    ...
    @Test
    void compareEquals() {
        int result = regionComparator.compare(car1, car1);
        assertEquals(0, result);
        assertFalse(result > 0);
        assertFalse(result < 0);

        result = regionComparator.compare(car2, car2);
        assertEquals(0, result);
        assertFalse(result > 0);
        assertFalse(result < 0);

        result = regionComparator.compare(car3, car3);
        assertEquals(0, result);
        assertFalse(result > 0);
        assertFalse(result < 0);
    }
    ...
    void compareGreaterThan() {
        int result = regionComparator.compare(car1, car2);
        assertTrue(result > 0);
        assertNotEquals(0, result);
        assertFalse(result < 0);

        result = regionComparator.compare(car3, car2);
        assertTrue(result > 0);
        assertNotEquals(0, result);
        assertFalse(result < 0);

        result = regionComparator.compare(car1, car3);
        assertTrue(result > 0);
        assertNotEquals(0, result);
        assertFalse(result < 0);
    }
    ...
    void compareSmallerThan() {
        int result = regionComparator.compare(car2, car1);
        assertTrue(result < 0);
        assertNotEquals(0, result);
        assertFalse(result > 0);

        result = regionComparator.compare(car2, car3);
        assertTrue(result < 0);
        assertNotEquals(0, result);
        assertFalse(result > 0);

        result = regionComparator.compare(car3, car1);
        assertTrue(result < 0);
        assertNotEquals(0, result);
        assertFalse(result > 0);
    }
